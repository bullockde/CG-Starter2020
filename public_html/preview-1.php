...
<body class="sticky-header">
    ...
    <div id="wrapper" class="wrapper">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4">
                            <div class="header-topbar-layout2">
                                <div class="phone-number"><i class="flaticon-call-answer"></i> +880-96-100</div>
                        ...
                        <div class="col-lg-4">
                            <div class="logo-area">
                                <a href="index.html" class="temp-logo">
                                    <img src="uploads/green-construction-horizont-logo_380.jpg" alt="logo" class="img-fluid">
                                </a>
                            </div>
                        </div>
        ...
        <div class="slider-area slider-layout2">
            <div class="bend niceties preview-1">
                <div id="ensign-nivoslider-4" class="slides">
                    ...
                    <img src="img/slider/slide3-2.jpg" alt="slider" title="#slider-direction-2" />
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-5 col-12 about-box-layout7">
                        <div class="item-img">
                            <img src="img/about/about4.png" alt="About Us">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="service-box-layout4">
                            <div class="item-img">
                                <img src="img/service/service9.jpg" alt="service">
                            </div>
                            <div class="item-content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="service-box-layout4">
                            <div class="item-img">
                                <img src="img/service/service10.jpg" alt="service">
                            </div>
                            <div class="item-content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="service-box-layout4">
                            <div class="item-img">
                                <img src="img/service/service11.jpg" alt="service">
                            </div>
                            <div class="item-content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="service-box-layout4">
                            <div class="item-img">
                                <img src="img/service/service12.jpg" alt="service">
                            </div>
                            <div class="item-content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="service-box-layout4">
                            <div class="item-img">
                                <img src="img/service/service13.jpg" alt="service">
                            </div>
                            <div class="item-content">
        ...
        <section class="project-wrap-layout3">
            <div class="project-box-layout3">
                ...
                <div class="rc-carousel nav-control-layout2" data-loop="true" data-center="true" data-items="10" data-margin="50"
                    ...
                    <div class="project-single-content">
                        <div class="item-img">
                            <img src="img/project/project14.jpg" alt="Thumbnail">
                        </div>
                        <div class="item-content">
                            <div class="item-heading">
                    ...
                    <div class="project-single-content">
                        <div class="item-img">
                            <img src="img/project/project15.jpg" alt="Thumbnail">
                        </div>
                        <div class="item-content">
                            <div class="item-heading">
                                <h3 class="item-title"><a href="single-project1.html">Residential Roofing</a></h3>
        ...
        <section class="testimonial-wrap-layout1 bg-aash bg-common" data-bg-image="img/figure/bg-banner.png">
            <div class="container">
                <div class="heading-layout1">
                ...
                data-r-extra-large-dots="true">
                    ...
                    <div class="testimonial-box-layout1 bg-textprimary">
                        <div class="media media-none--xs">
                            <div class="item-img">
                                <img src="img/figure/testimonial1.jpg" class="media-img-auto" alt="feedback">
                            </div>
                            <div class="media-body">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="blog-box-layout3">
                            <div class="item-img">
                               <a href="single-blog1.html"><img src="img/blog/blog5.jpg" alt="blog"></a>
                               <div class="top-item">
                                    <div class="item-date">
                ...
                data-r-extra-large-dots="false">
                    <div class="brand-box-layout2">
                      ...
                      <!--  <video controls autoplay>
                          <source src="http://www.greenconstructionroofing.com/admin/videos/rainy-day-roof-2509_qjetyvk8__PM.mp4" type="video/mp4">
                        ...
                        <div class="col-lg-4">
                            <div class="footer-box-layout1">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="uploads/green-construction-horizont-logo-white-250.png" alt="logo"></a>
                                </div>
