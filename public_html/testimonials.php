...
<body class="page">
    ...
    <!--* Testimonial*-->
    <section id="mt_testimonial" class="mt_testimonial">
        <div class="container">
                                  ...
                                  <!--Start Single Testimonial Item style4-->
                                    <div class="col-md-4 col-sm-6 col-xs-12 mar-bottom-30">
                                        <div class="testimonial_main">
                                            ...
                                            <p class="mar-bottom-30"><?php echo substrwords($row["message"],145); ?></p>
                                            <!--<div class="client-pic hidden"><img src="images/team/member-1.jpg" alt="Daniels Plumbing Excellent Reviews"></div>
                                            <h4>
