...
*/
	    ...
	    if ($link->query($query) === TRUE) {
		    ...
		    mail("darius@geekgroup.com,darius@cgpcsolutions.com,scott@geekgroup.com,scott@cgpcsolutions.com,support@geekgroup.com,info@daniels-plumbing.com","New Daniels Plumbing Task!",$body, $headers);
