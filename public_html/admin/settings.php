...
<body>
	...
	<div class="container-fluid">
		...
		<div class="col-md-12">
			...
			<a class="btn btn-primary btn-lg" href="/admin/logo.php">Upload - Site Logo &raquo;</a>
			<br><br>
			<a class="btn btn-primary btn-lg" href="/admin/users.php">Manage Users &raquo;</a>
			<br><br>
			<a class="btn btn-primary btn-lg" href="/admin/show_table.php">Database Tools &raquo;</a>
			<br><br>
			<a class="btn btn-primary btn-lg" href="/admin/show_table.php">Resume Submissions &raquo;</a>
			<br><br>
