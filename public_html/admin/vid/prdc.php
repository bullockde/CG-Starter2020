                      ...
                      <div class="row">
                        ...
                        <div class="col-md-8 menu">
                           ...
                           <h1 class="text-center">
                              <strong><?php echo $row['heading']; ?></strong><br><span style="font-size: 0.4em; font-weight: 500; position: relative; top: -10px;">August 16, 2019</span>
                            </h1>
                            ...
                            <br><b>HIGH BLOOD PRESSURE</b> Apple, Carrot, Spinach 
