   ...
   <!-- <ol class="carousel-indicators">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      while($row=mysqli_fetch_array($result)){
        ...
        $img_loc = null;
        $query2 = "SELECT * FROM video_images WHERE video_id='".$row["id"]."' LIMIT 1";
                          ...
                          <div class="col-md-6  text-center menu ">
                            ...
                            <div class="featured ">
                              ...
                              <div style="width: 55%; height: 20px; border-bottom: 1px solid black; text-align: center; margin: 0 auto;">
                                <span style="font-size: 22px; background-color: #FFF; padding: 0 10px;display:none;">
                          ...
                          <div class="row vertical-align">
                            ...
                            <div class="col-md-6  text-center menu ">
                              ...
                              <div class="featured ">
                                ...
                                <div class="text-center logo">
                                  <img src="/uploads/elaine-cheung-logo.png" width="150" class="mx-auto">
                                </div>
