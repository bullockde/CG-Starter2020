<?php
	...
	if ( $_POST['email_task']  && ( $_POST['sure'] == "Yes" ) ) {
		  ...
		  $body = "<h1>You have a New Task - Pending Approval!</h1>"
		  		...
		  		. "<h3>View this task at: https://www.daniels-plumbing.com/work.php?type=plans&id=$task_id</h3>";

		 //info@daniels-plumbing.com
		  		
	    mail("darius@cgpcsolutions.com,info@daniels-plumbing.com","New Daniels Plumbing Task!",$body, $headers);
...
*/
	    ...
	    if ($link->query($query) === TRUE) {
		    ...
		    mail("darius@cgpcsolutions.com,scott@cgpcsolutions.com","New Daniels Plumbing Task!",$body, $headers);
...
<body>
	...
	<div class="container-fluid col-print-12">
		...
		<h1>
			<?php echo $page_title; ?>
			<a href="<?php echo $site_base; ?>admin/project-plans.php" class="pull-right btn btn-default" >Project Plans >></a>
			<br>
			...
			while($row=mysqli_fetch_array($result)){
				...
				<form method="post" enctype='multipart/form-data'>
				    <div class='col-lg-2 well1'>
				        	...
				        	<input type='submit' value='Email Task' name='send_task' class='btn btn-block btn-success1' >
