<?php
	...
	if(isset($_POST['Delete']) && isset($id)) 
	{
		...
		$query2 = "UPDATE $type SET deleted = '1' WHERE id = '$id'";
			...
			<div class="col-md-12">
				<form method="post" role="form" enctype="multipart/form-data">
					<div class="form-group">
						<h3>Move <?php echo $title; ?> from <?php echo $type; ?> to Archives?</h3>
					</div>
					<div class="form-group">
						<input type="submit" name="Delete" value="Archive &raquo;" class="btn btn-warning form-control" />
					</div>
				</form>
			</div>
		</div>
