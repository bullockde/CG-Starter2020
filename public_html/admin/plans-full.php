<?php
	...
	if( isset( $_POST['status'] ) ){
		...
		$id = $_POST['id'];
		$status_update = "UPDATE $page_slug SET status = '$status', notes = '$notes' WHERE id = '$id'";
	    		...
	    		<form method="post" enctype='multipart/form-data'>
					    <div class='col-lg-12 well'>
					    	...
					    	<div class="col-lg-1 col-xs-6">
					        	...
					        	<!-- -->
					        	<input type="text" name="start_date" placeholder="Start Date" style="width: 100%;" />
					        ...
					        <div class="col-lg-4 col-xs-6">
					        	...
					        	<div class="col-xs-5">
					        		<input type="text" name="start_time" placeholder="Start Time" style="width: 100%;" />
					        	</div>
					        	<div class="col-xs-1">
					        		-
					        	</div>
					        	<div class="col-xs-5">
					        		<input type="text" name="end_time" placeholder="End Time" style="width: 100%;" />
					        	</div>
					        ...
					        <div class="col-lg-4">
					        	<textarea name='notes' class="form-control bcontent" placeholder="Notes" style="width: 100%;"></textarea>
					        	<br>
					        	<br class="hidden-lg">
					        </div>
					        <div class="col-lg-3">
				...
				while($row2=mysqli_fetch_array($result2)){ $img_loc = $row2['location']; }
				    ...
				    <div class='col-lg-12 well <?php echo $color;?>'>
				    	<div class="col-lg-5 col-xs-6" contenteditable="false">
				        	<!-- -->
				        		<b><?php echo $row["id"]; ?></b> - <input type="checkbox" name="check<?php echo $row["id"]; ?>" value="Completed"> &nbsp;&nbsp; <b class="title"><?php echo $row["title"]; ?></b>
