...
<?php
	...
	if( isset( $_POST['new_review'] ) ){
	    ...
	    echo "<script type='text/javascript'>window.location.href = '/admin/reviews.php';</script>";
				    ...
				    <div class='col-lg-12 well'>
				        ...
				        <div class="col-lg-2 col-xs-6">
				        		...
				        		<?php 
				        			if( $row["email"] != ""){
				        				?>
				        					<a href="/inc/sendmail-review.php?name=<?php echo $row['name']; ?>&email=<?php echo $row['email']; ?>" class="btn btn-default btn-block"> Regular Email &raquo; </a>
				        		...
				        		<?php 
				        			if( $row["email"] != ""){
				        				?>
				        					<a href="/inc/fancymail.php?type=regular&name=<?php echo $row['name']; ?>&email=<?php echo $row['email']; ?>" class="btn btn-default btn-block"> Fancy Regular Email &raquo; </a>
				        		...
				        		<?php 
				        			if( $row["phone"] != ""){
				        				?>
				        					<a href="/send-reviews.php?type=regular&p=<?php echo $row["phone"]; ?>" class="btn btn-default btn-block"> Regular Text &raquo; </a>
				        ...
				        <div class="col-lg-2 col-xs-6">
				        		...
				        		<?php 
				        			if( $row["email"] != ""){
				        				?>
				        					<a href="/inc/sendmail-dispatch-review.php?name=<?php echo $row['name']; ?>&email=<?php echo $row['email']; ?>" class="btn btn-primary btn-block"> Dispatch Email &raquo; </a>
				        		...
				        		<?php 
				        			if( $row["email"] != ""){
				        				?>
				        					<a href="/inc/fancymail.php?type=dispatch&name=<?php echo $row['name']; ?>&email=<?php echo $row['email']; ?>" class="btn btn-primary btn-block"> Fancy Dispatch Email &raquo; </a>
				        		...
				        		<?php 
				        			if( $row["phone"] != ""){
				        				?>
				        					<a href="/send-reviews.php?type=dispatch&p=<?php echo $row["phone"]; ?>" class="btn btn-primary btn-block"> Dispatch Text &raquo; </a>
				        				<?php
				        			}
				        		?>
