				    ...
				    <div class='col-lg-12 well'>
				        ...
				        <div class="col-lg-2 col-xs-6">
				        		...
				        		<?php 
				        			if( $row["phone"] != ""){
				        				?>
				        					<a href="/admin/confirm.php?action=Text&id=<?php echo $row[id]; ?>&type=reviews&text_type=regular&p=<?php echo $row["phone"]; ?>" class="btn btn-default btn-block"> Regular Text &raquo; </a>
