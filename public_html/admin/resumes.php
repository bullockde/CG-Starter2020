...
<h1>Database Table: <?php echo "{$table}"; ?></h1>
...
<?php
    ...
    if ( /*isset($_POST['show_table']) && !isset($_POST['fields'])*/ 1 ) { echo "<b>Select Columns to Display:</b><br>"; }
for($i=0; $i<$fields_num; $i++)
{
    ...
    if ( /*isset($_POST['show_table']) && !isset($_POST['fields'])*/ 1 ) {
...
if ( /* isset($_POST['fields'])*/ 1 ) {
    ...
    while($row = mysqli_fetch_row($result))
    {
        ...
        foreach($row as $cell){
            ...
            if ( /*in_array($cnt++,$fields)*/ $cnt++ == 3 ) {
                echo "<td><a target='_blank' href='" . $site_base . "uploads/$cell'>$cell</a></td>";
            }else{
                echo "<td>$cell</td>";
            }
