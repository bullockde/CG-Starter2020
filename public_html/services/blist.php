        ...
        <div class="blog classic-view">
          ...
          <?php 
                    ...
                    { 
                      ...
                      $query = "SELECT * FROM blogs WHERE landing = 1 ORDER BY created DESC LIMIT 0 , 3";
                    }
          ...
          <center>
                    ...
                    <?php
                        ...
                        if ($_GET["tag"]) {
                            ...
                            $query = "SELECT * FROM blogs WHERE landing = 1 ORDER BY created DESC";
